...
SECRET_KEY = 'django-insecure-_@6r=m1as#t42t*246e9=7hbzy^@8q8b0-&irc)$igwwzh)lx1'
...
LOGGING = {
    ...
    'loggers': {
        'api.views': {  # Change 'api' if your app is named differently
            'handlers': ['console'],
            'level': 'DEBUG',
            'propagate': True,
        },
